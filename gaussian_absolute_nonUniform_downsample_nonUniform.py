...
def downsample(feats, n_samples, parameter1, parameter2):
    ...
    with a non-uniform gaussian filter, which means the standard deviation of the gaussian filter varies according to the downsampling position.
    ...
    parameter1: float
       the initial standard deviation of the gaussian filter.
