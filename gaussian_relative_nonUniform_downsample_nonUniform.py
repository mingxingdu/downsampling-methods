...
def downsample(feats, n_samples, parameter1, parameter2):
    ...
    with a gaussian filter, its standard deviation is varaiant according to the length of the input and the downsampling position.
    ...
    if n_samples % 2 ==0 :
        ...
        scales = scales * skewness + coefficient * n_feats
    else :
